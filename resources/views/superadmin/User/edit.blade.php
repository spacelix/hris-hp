<x-app-layout>
    <div
        ...
        <div class="w-full mb-1">
            <h1 class="text-xl font-semibold text-gray-900 sm:text-2xl dark:text-white mb-3">Edit User</h1>
            <form class="w-full mt-6" action="{{ route('users.update', $user->id) }}" method="POST"
                    ...
                    <div class="relative z-0 w-full mb-6 group">
                        ...
                        <div class="flex">
                            ...
                            <input type="text" id="name" name="name"
                                class="rounded-none rounded-r-lg bg-gray-50 border border-gray-300 text-gray-900 focus:ring-blue-500 focus:border-blue-500 block flex-1 min-w-0 w-full text-sm p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                placeholder="JhonDoe" value="{{ old('name', $user->name) }}">
                        </div>
                ...
                <div class="grid md:grid-cols-2 md:gap-6">
                    <div class="mb-6">
                        ...
                        <div class="relative mt-6">
                            ...
                            <img class="img-preview w-24 h-24 rounded-full" src="{{ asset('storage/' . $user->image) }}"
                                alt="Avatar">
                        </div>
                    </div>
                    <div class="mb-6">
                        ...
                        <select id="role" name="role" disabled
                            class="block w-full text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400">
                            <option value="">{{ $user->getRoleNames() }}</option>
